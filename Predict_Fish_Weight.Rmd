...
For Perch the best two regression models is height and width. The overall best is also height and width with an adjusted R square 
```{r}
...
### Best Two regressor model
The regression model is L1,L2,L3-H-W . The best two are Length- Length3.
